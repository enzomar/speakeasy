...
SEARCH_OVERRIDES = {
    ...
    "dc_ready": "ready",
    # ── Feelings ──
    "f_frustrated": "annoyed",
    # ── Places ──
    "lc3_therapy": "rehabilitation",
    # ── People ──
    "p_therapist": "speech therapist",
    # ── Question helpers ──
    "q_canI": "permission",
    "q_canYou": "request",
    "q_doYouHave": "have",
    "q_isIt": "question mark",
    "q_whatTime": "what time",
    # ── Question L3 detail topics ──
    "q3_canhelp": "help",
    "q3_cantI": "forbidden",
    "q3_cidrink": "drink",
    "q3_cieat": "eat",
