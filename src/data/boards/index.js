...
const BOARDS = [
  ...
  // Broad daily context — priorityL2 to float relevant items up but keep all.
  {
    ...
    l3Filter: {
      ...
      // describe — home-relevant modifiers
      dc_good:  ["x_very", "x_not", "x_little", "o_food", "o_tv", "o_music", "t_now"],
      dc_hot:   ["x_very", "x_not", "x_little", "o_food", "o_water"],
      dc_cold:  ["x_very", "x_not", "x_little", "o_food", "o_water"],
      dc_loud:  ["x_very", "x_not", "x_little", "x_please", "pl_here", "o_tv", "o_music"],
      dc_quiet: ["x_very", "x_not", "pl_here"],
      dc_big:   ["x_very", "x_not"],
      dc_small: ["x_very", "x_not"],
      dc_nice:  ["x_very", "x_not"],
    },
    sentenceOverrides: {
      // DESCRIBE — home context
      "describe:dc_good":         ["It is good", "That's good"],
      "describe:dc_good:o_food":  ["The food is good"],
      "describe:dc_good:o_tv":    ["The show is good"],
      "describe:dc_good:o_music": ["The music is good"],
      "describe:dc_hot":          ["It is hot", "I am hot"],
      "describe:dc_hot:o_food":   ["The food is hot", "Be careful, it is hot"],
      "describe:dc_cold":         ["It is cold", "I am cold"],
      "describe:dc_cold:o_food":  ["The food is cold"],
      "describe:dc_loud":         ["It is loud", "Too loud"],
      "describe:dc_loud:o_tv":    ["The TV is too loud"],
      "describe:dc_loud:o_music": ["The music is too loud"],
      "describe:dc_loud:x_please":["Quieter please", "Turn it down please"],
      "describe:dc_loud:pl_here": ["It is loud in here"],
      "describe:dc_quiet":        ["It is quiet", "Nice and quiet"],
  ...
  // Gathering/party. Broad but with social L3 focus.
  {
    ...
    l3Filter: {
      ...
      dc_loud:  ["x_very", "x_little", "x_not", "x_please", "pl_here"],
      dc_quiet: ["x_very", "x_little", "x_not", "pl_here"],
      dc_good:  ["x_very", "x_not", "x_little", "o_food", "o_music"],
      dc_nice:  ["x_very", "x_not"],
      dc_hot:   ["x_very", "x_not", "x_little"],
      dc_cold:  ["x_very", "x_not", "x_little"],
    },
    sentenceOverrides: {
      // DESCRIBE — social context
      "describe:dc_good":           ["It is good", "This is fun"],
      "describe:dc_good:o_food":    ["The food is good", "This is delicious"],
      "describe:dc_good:o_music":   ["The music is good", "Great music"],
      "describe:dc_good:x_very":    ["It is really good", "This is amazing"],
      "describe:dc_nice":           ["This is nice", "How nice"],
      "describe:dc_nice:x_very":    ["This is really nice"],
      "describe:dc_loud":           ["It is loud", "Too loud"],
      "describe:dc_loud:x_very":    ["It is very loud", "Way too loud"],
      "describe:dc_loud:x_please":  ["Can it be quieter please?", "Too loud please"],
      "describe:dc_loud:pl_here":   ["It is loud in here"],
      "describe:dc_quiet":          ["It is quiet"],
      "describe:dc_quiet:pl_here":  ["It is quiet here"],
      "describe:dc_hot":            ["It is hot", "I am hot"],
      "describe:dc_hot:x_very":     ["It is very hot in here"],
      "describe:dc_cold":           ["It is cold", "I am cold"],
